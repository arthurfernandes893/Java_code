public class ValidaCPF{
    ...
    public static boolean isCPF(String scpf){ //assumir que esta sendo passado um cpf "limpo"//
        int i = 10; int somaaux =0; int soma = 0;
        int location = 0;
        char firstdigit; char seconddigit;
        ...
        || scpf.equals("00000000000")){
            ...
            if((firstdigit == scpf.charAt(9)) && (seconddigit == scpf.charAt(10))){
                System.out.println("string cpf: "+scpf +"index9: "+ scpf.charAt(9) +" index10: "+ scpf.charAt(10));
                System.out.println("");
                return true;
            }
            else{
    ...
    public static String limpaCPF(String scpf){ 		
        ...
        auxcpf = auxcpf.replace('.','-'); // substituir sinais de . por -//
