...
public class Mulher extends Pessoa{
    ...
    public Mulher(String nomelido,String sobrenomelido,String numcpflido, GregorianCalendar datalida, int idade){
        super(nomelido, sobrenomelido, numcpflido, datalida);
        this.idade = idade;
    }
